...
{ 
  ...
  if(Serial.available())
 {
    ...
    switch(x)
    {
      case'w':lift90();Serial.println("downdown");delay(t);break;
      case'a':downdown();Serial.println("downdown");delay(t);break;
      case'e':upup();Serial.println("upup");delay(t);break;
      case'u':liftup();Serial.println("liftup");delay(t);break;
      case'd':putdown();Serial.println("putdown");delay(t);break;
      case's':sweep_1();Serial.println("sweep_1");delay(t);break;
      case'q':sweep_2();Serial.println("sweep_2");delay(t);break;
      case'b':sweepback();Serial.println("sweepback");delay(t);break;
      case'c':clockwise();Serial.println("clockwise");delay(t);break;
      case'o':counterclockwise();Serial.println("counterclockwise");delay(t);break;
    }
  }
  if(BT.available()>0){
    char c=BT.read();
